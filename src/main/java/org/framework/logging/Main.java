...
public class Main {
    ...
    private static void demoCustomFormatters() {
        ...
        //LogFormatter customFormatter = new SimpleFormatter("[%LEVEL] %TIMESTAMP - %MESSAGE");
        LogFormatter customFormatter = new DetailedFormatter("[%LEVEL] %TIMESTAMP [%SOURCE] - %MESSAGE");
    ...
    private static void demoFilters() {
        ...
        LogFilter levelFilter = new LevelFilter(LogLevel.WARNING);
